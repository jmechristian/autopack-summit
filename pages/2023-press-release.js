        ...
        <div className='w-full max-w-3xl mx-auto'>
          <div className='flex flex-col gap-6 xl:gap-9 xl:text-lg'>
            <p>
              ...
              The 2023 Automotive Packaging Summit was held October 11 & 12th at
              the Peace Center’s Huguenot Mill and Loft in Greenville, SC. This
              year the event once again delivered quality education and
              networking to a sold-out audience of nearly 300 packaging
              professionals from OEMs and Tier 1 Suppliers like GM, BMW, Magna,
              Volvo, Nissan, Plastic Omnium, Caterpillar and Bosch.
            </p>
            <p>
              When asked about the event’s success Dr. Andrew Hurley, Founder of
              The Packaging School shared, “I’m pleased to report that AutoPack
              Summit 2023 received overwhelming positive feedback from those in
              attendance. Networking, education and relationship building were
              cited as benefits of attending, which is a testament to the
              quality audience that flocked to the event. Watching so many of
              the audience members taking notes and scheduling future meetings
              throughout the conference was a treat.”
            </p>
            <div
            ...
            <p>
              ...
              from across the globe. Attendees were also able to participate in
              optional tours including Magna Drive Corporation in Piedmont SC
              and Clemson University’s International Center for Automotive
            ...
            <p>
              ...
              Corporation, Darrin Lucas with Nissan Group of America, Werner Els
              and Drew Cockman with BMW Manufacturing Company LLC, Terry Barnes
              with Artiflex, Gauri Awalgaonkar with Bosch, Kasie Harmon with
              TriEnda and Jason Skrobot with Toyota Manufacturing Kentucky.
              These distinguished individuals dedicated their time to the
              strategic planning of the event, and some also served as speakers.
            </p>
            <figure className='my-6 border-l-8 border-ap-yellow pl-9'>
              <blockquote className='font-semibold text-neutral-500 text-xl xl:text-2xl xl:leading-normal'>
                <p>
                  ...
                  speakers, the venue, and the OEM participation is phenomenal.
                  It’s a phenomenal event for us, as we are so happy to be the
                  title sponsor.”
                </p>
              </blockquote>
            ...
            <p>
              ...
              returnable packaging challenges to the quickly evolving technology
              solutions including sensor technology for automotive assets.
            </p>
            <p>
              EV battery packaging was a hot topic relevant topic at this year's
              event as it ties in directly with South Carolina’s new battery
            ...
            <p>
              ...
              Packaging Certificate Program with an entire module on Sustainable
              approaches for Automotive Packaging&mdash;learn more{' '}
              <a
            ...
            <p>
              ...
              for a glimpse into the compelling education and vibrant networking
              that took place at the 2023 event.
            </p>
            <p>
              ...
              continue to raise the bar as we are anticipating the event to grow
              by 40%.
            </p>
            ...
            <div className='flex flex-col gap-3 pt-12 border-t'>
              ...
              <p>
                ...
                suppliers to discuss their packaging innovations and challenges.
                The goal is to collaborate for a more efficient and
                cost-effective supply chain for both automotive and the economy.
                AutoPack Summit has continued to grow every year of its
                existence. Tickets have sold out all seven years and its reach
                has become international. We have welcomed attendees from the
                US, UK, Canada, Mexico, Japan, Italy, Belgium, India, Germany,
                Poland, Hong Kong, Brazil, Netherlands, Sweden, South Africa,
                Nigeria, France, Switzerland, Finland, and Bulgaria. For
                information on the 2024 event please visit
                <a
            ...
            <div className='flex flex-col gap-3'>
              <h3 className='font-bold text-lg'>About The Packaging School</h3>
              <p>
                The Packaging School is the exclusive licensee of a professional
                packaging curriculum developed at Clemson University. Founded in
                2015, by Dr. Andrew Hurley, The Packaging School bridges the gap
                between academia and industry by partnering with companies,
                subject matter experts and associations to create a shared
                learning management system. Our expanded course catalog enables
                knowledge-seekers to connect with knowledge-providers in all
                facets of packaging and processing. Our mission is to provide
                accessible and applicable online education to a global audience
                by training the leaders of tomorrow in the art and science of
                packaging. For more information about our Packaging certificates
                and courses, visit{' '}
                <a
