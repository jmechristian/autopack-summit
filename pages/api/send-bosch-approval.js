...
import BoschWelcomeEmail from '../../react-email-starter/emails/bosch-confirmation';
...
export default async function handler(req, res) {
  const body = req.body;
  const emailHtml = render(<BoschWelcomeEmail topics={body.topics} />);
