...
const WhyMain = () => {
  ...
  return (
    <div className='w-full h-full relative'>
      <div className='py-12 md:py-16 px-8 max-w-7xl grid grid-cols-1 md:grid-cols-2 md:gap-x-12 gap-y-12'>
        <div className='flex flex-col gap-12 md:gap-32'>
          <motion.div
            className='flex flex-col items-center xl:gap-2 mx-auto md:mt-16'
            ref={whyHeadlineRef}
