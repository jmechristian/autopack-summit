...
const HeroMain = ({ headline, subheadline, text, location, date, logos }) => {
  return (
    <div
      className='w-full h-[90vh] md:h-[85vh] lg:h-[90vh] xl:h-[98vh] pt-52 pb-10 md:pt-56 lg:pb-10 lg:pt-64 xl:pb-12 xl:pt-[18rem] bg-slate-800 relative overflow-hidden bg-center'
      style={{
    ...
    >
      <div className='w-full h-full flex flex-col justify-between items-center'>
        <div className='flex flex-col gap-16 md:gap-32 lg:gap-32 xl:gap-44'>
