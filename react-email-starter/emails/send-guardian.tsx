...
export const SendGuardianEmail = ({ data }: SendGuardianEmailProps) => {
  return (
    <Html>
      <Tailwind>
        <Head />
            ...
            <Section className='my-5'>
              ...
              <Row>
                <Column className='text-center'>
                  <Button
                    href={`https://autopacksummit.com/workshops/guardian/approve?id=${data.data.id}&email=${data.data.email}`}
...
SendGuardianEmail.PreviewProps = {
  data: {
    data: {
...
} as SendGuardianEmailProps;

export default SendGuardianEmail;
