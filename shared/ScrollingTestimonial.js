  ...
  return (
    <div className='bg-white py-12'>
      ...
      <div className='p-4 overflow-x-hidden relative'>
        <div className='absolute top-0 bottom-0 left-0 w-24 z-10 bg-gradient-to-r from-slate-200 to-transparent' />
    ...
    >
      {list.map((t) => {
        return (
          <div
            key={t.id}
            className='shrink-0 w-[500px] grid grid-cols-[6rem,_1fr] rounded-lg overflow-hidden items-start relative ring-4 ring-black'
          >
            <div
              className='aspect-[1/1] rounded-full bg-indigo-400 w-20 mx-auto mt-4 bg-cover bg-center'
